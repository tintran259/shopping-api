...
export class Init1782312974436 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1ecae3acee67b8f1b5ae9f5149" ON "wishlists" ("customer_id") `);
        await queryRunner.query(`CREATE TYPE "public"."vouchers_type_enum" AS ENUM('percent', 'fixed', 'shipping')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_fulfillment_enum" AS ENUM('delivery', 'pickup')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_method_code_enum" AS ENUM('bank_transfer', 'momo', 'atm_card', 'cod')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e290dcae2c0ff391ceea3e8978" ON "shipping_methods" ("code") `);
        await queryRunner.query(`CREATE TYPE "public"."shipments_status_enum" AS ENUM('pending', 'shipped', 'delivered')`);
        ...
        await queryRunner.query(`CREATE TABLE "back_in_stock_subscriptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "variant_id" character varying NOT NULL, "branch_id" uuid, "customer_id" uuid, "contact" character varying NOT NULL, "notified_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_032ce35c8240262d281dbe9d28f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3084ab1ce203cff522888bf5e7" ON "back_in_stock_subscriptions" ("variant_id") `);
        await queryRunner.query(`CREATE TABLE "provinces" ("code" integer NOT NULL, "name" character varying NOT NULL, "division_type" character varying, "codename" character varying, "phone_code" integer, CONSTRAINT "PK_f4b684af62d5cb3aa174f6b9b8a" PRIMARY KEY ("code"))`);
        await queryRunner.query(`CREATE TABLE "wards" ("code" integer NOT NULL, "name" character varying NOT NULL, "division_type" character varying, "codename" character varying, "province_code" integer NOT NULL, CONSTRAINT "PK_24f16d2207b1dcb6ce07d81d20f" PRIMARY KEY ("code"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6c3a8d384c72ec02bd6dc0ebfe" ON "wards" ("province_code") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_bc96df35477b27f8c7a9a214ee" ON "customers" ("email") WHERE "email" IS NOT NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."product_options_display_type_enum" AS ENUM('swatch', 'pill', 'dropdown')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('active', 'draft', 'preorder', 'out_of_stock', 'discontinued')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d40b39783ca1a0db443aa422d9" ON "price_list_items" ("price_tier_id", "variant_id") `);
        await queryRunner.query(`CREATE TABLE "price_tiers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_32e26c73f31f2d3a75bb2143d62" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."inventory_status_enum" AS ENUM('in_stock', 'preorder', 'out_of_stock')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c351cd4db6142b522da9068838" ON "inventory" ("branch_id", "variant_id") `);
        await queryRunner.query(`CREATE TABLE "variant_option_values" ("variant_id" uuid NOT NULL, "option_value_id" uuid NOT NULL, CONSTRAINT "PK_44501649a4f45de8e349946225d" PRIMARY KEY ("variant_id", "option_value_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3d396f66a33e2328f439515abd" ON "variant_option_values" ("variant_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_c80b92276d57bd3b469eccd62e" ON "variant_option_values" ("option_value_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "voucher_redemptions" ADD CONSTRAINT "FK_0af64d5936a69889a91978ce812" FOREIGN KEY ("voucher_id") REFERENCES "vouchers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "shipments" ADD CONSTRAINT "FK_c0b004da33090be7e934ac28e2b" FOREIGN KEY ("shipping_method_id") REFERENCES "shipping_methods"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "wards" ADD CONSTRAINT "FK_6c3a8d384c72ec02bd6dc0ebfef" FOREIGN KEY ("province_code") REFERENCES "provinces"("code") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "b2b_profiles" ADD CONSTRAINT "FK_08672de6cf51488acf8bd8c54c1" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "price_list_items" ADD CONSTRAINT "FK_dea392c4046b1a86d1bc1557dc9" FOREIGN KEY ("price_tier_id") REFERENCES "price_tiers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_list_items" ADD CONSTRAINT "FK_bb9d00bdcb2b2578c8d2cc96438" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "variant_option_values" ADD CONSTRAINT "FK_3d396f66a33e2328f439515abdf" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "variant_option_values" ADD CONSTRAINT "FK_c80b92276d57bd3b469eccd62eb" FOREIGN KEY ("option_value_id") REFERENCES "product_option_values"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "variant_option_values" DROP CONSTRAINT "FK_c80b92276d57bd3b469eccd62eb"`);
        await queryRunner.query(`ALTER TABLE "variant_option_values" DROP CONSTRAINT "FK_3d396f66a33e2328f439515abdf"`);
        ...
        await queryRunner.query(`ALTER TABLE "price_list_items" DROP CONSTRAINT "FK_bb9d00bdcb2b2578c8d2cc96438"`);
        await queryRunner.query(`ALTER TABLE "price_list_items" DROP CONSTRAINT "FK_dea392c4046b1a86d1bc1557dc9"`);
        ...
        await queryRunner.query(`ALTER TABLE "b2b_profiles" DROP CONSTRAINT "FK_08672de6cf51488acf8bd8c54c1"`);
        ...
        await queryRunner.query(`ALTER TABLE "voucher_redemptions" DROP CONSTRAINT "FK_0af64d5936a69889a91978ce812"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c80b92276d57bd3b469eccd62e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3d396f66a33e2328f439515abd"`);
        await queryRunner.query(`DROP TABLE "variant_option_values"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c351cd4db6142b522da9068838"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_d40b39783ca1a0db443aa422d9"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."product_options_display_type_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bc96df35477b27f8c7a9a214ee"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6c3a8d384c72ec02bd6dc0ebfe"`);
        await queryRunner.query(`DROP TABLE "wards"`);
        await queryRunner.query(`DROP TABLE "provinces"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3084ab1ce203cff522888bf5e7"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e290dcae2c0ff391ceea3e8978"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_3e413c10c595c04c6c70e58a4d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0af64d5936a69889a91978ce81"`);
